            ...
            try
            {
                ...
                for (var i = 0; i < files.Count(); i++)
                {
                    ...
                    if (file is not null)
                    {
                        ...
                        {
                            LossyQualityLevel = WebpToolkitPackage.OptionsPage?.LossyQuality ?? OptionsPageGrid.DefaultLossyQuality,
                            AllowOverwrite = WebpToolkitPackage.OptionsPage?.IsOverwriteEnabled ?? true,
                            AllowNearLossless = WebpToolkitPackage.OptionsPage?.AllowNearLossless ?? true,
                        };
